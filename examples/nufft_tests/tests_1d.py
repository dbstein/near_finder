...
def test(n, m, eps=1e-14):
    ...
    print('Difference, direct/periodic_interp, 1 density:   {:0.2e}'.format(allclose(out1_dir, out1_fi)))
    print('Difference, direct/periodic_interp, 3 densities: {:0.2e}'.format(allclose(out2_dir, out2_fi)))
